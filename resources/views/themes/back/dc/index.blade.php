                    ...
                    @foreach($cmfs as $cmf)
                        <tr class="
                            ...
                            <td>
                                ...
                                @else
                                    @if($cmf->step == 1)
                                        <a href="{{route('cmf.dc.verifikasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Review</a>
                                    @elseif($cmf->step == 2)
                                        <a href="{{route('cmf.dc.verifikasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Review</a>
                                    @elseif($cmf->step == 3)
                                        <a href="{{route('cmf.dc.verifikasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Review</a>
                                    ...
                                    @elseif($cmf->step == 5)
                                        <a href="{{route('cmf.dc.verifikasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Review</a>
                                    @elseif($cmf->step == 6)
                                        <a href="{{route('cmf.dc.verifikasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Verifikasi</a>
                                    @elseif($cmf->step == 7)
                                        <a href="{{route('cmf.dc.verifikasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Verifikasi</a>
                                    @elseif($cmf->step == 8)
                                        <a href="{{route('cmf.dc.verifikasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Verifikasi</a>
                                    ...
                                    @elseif($cmf->step == 10)
                                        <a href="{{route('cmf.dc.verifikasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Verifikasi</a>
                                    @elseif($cmf->step == 11)
                                        <a href="{{route('cmf.dc.print',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Cetak</a>
                                    @endif
                                @endif
                            </td>
                        </tr>
