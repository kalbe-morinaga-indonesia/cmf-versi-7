...
@section('title','Evaluasi & Verifikasi CMF - CMF Online')

@section('content')
    <h4 class="fw-bold"><span class="text-muted fw-light">CMF / </span> Evaluasi & Verifikasi</h4>
            ...
            @if($cmf->step == 7)
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <form action="{{route('cmf.pic.update',['slug' => $cmf->slug])}}" method="post">
                            @csrf
