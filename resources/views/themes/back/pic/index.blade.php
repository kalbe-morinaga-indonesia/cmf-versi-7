                    ...
                    @foreach($cmf_pic as $cmf)
                        <tr class="
                            ...
                            <td>
                                ...
                                @else
                                    @if($cmf->step == 1)
                                        <a href="{{route('cmf.pic.verifikasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Review</a>
                                    @else
                                        <a href="{{route('cmf.pic.evaluasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Evaluasi & Verifikasi</a>
                                    @endif
                                @endif
                            </td>
                        </tr>
