            ...
            @if($cmf->step >= 8 && $cmf->step <= 9)
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <form action="{{route('cmf.dept.update',['slug' => $cmf->slug])}}" method="post">
                            @csrf
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <form action="#">
                                ...
                                <div class="form-floating my-4">
                                    <textarea class="form-control" name="catatan" placeholder="Leave a note here" id="catatan" @if($step->step == 9) disabled @endif>{{$step->catatan ?? ''}}</textarea>
                                    <label for="catatan">Catatan</label>
                                </div>
