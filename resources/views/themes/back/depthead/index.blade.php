                        ...
                        @foreach($cmf->departments as $department)
                            ...
                            ">
                                ...
                                <td>
                                    ...
                                    @else
                                        @if($cmf->step == 2 || $cmf->step == 3)
                                            <a href="{{route('cmf.dept.verifikasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Review</a>
                                        @else
                                            <a href="{{route('cmf.dept.evaluasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Evaluasi & Verifikasi</a>
                                        @endif
                                    @endif
                                </td>
                            </tr>
