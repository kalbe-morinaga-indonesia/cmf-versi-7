            ...
            @if($cmf->step >= 2 )
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <form action="{{route('cmf.dept.store',['slug' => $cmf->slug])}}" method="post">
                            @csrf
                            ...
                            <div class="form-check">
                                <input class="form-check-input @error('verifikasi') is-invalid @enderror" type="radio" name="verifikasi" id="tidak_setuju" value="tidak setuju">
                ...
                @if($step->step == 3)
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <form action="#">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="verifikasi" id="setuju" value="setuju" {{$step->step == 3 && $step->is_signature == 1 ? 'checked' : ''}} @if($step->step == 2) disabled @endif>
                                    <label class="form-check-label" for="setuju">
                                        Setuju
                                    </label>
                                </div>
