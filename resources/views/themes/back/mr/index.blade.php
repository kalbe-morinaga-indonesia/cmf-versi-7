                    ...
                    @foreach($cmfs as $cmf)
                        <tr class="
                            ...
                            <td>
                                ...
                                @else
                                    @if($cmf->step == 1)
                                        <a href="{{route('cmf.mr.verifikasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Review</a>
                                    @elseif($cmf->step == 2)
                                        <a href="{{route('cmf.mr.verifikasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Review</a>
                                    @elseif($cmf->step == 3)
                                        <a href="{{route('cmf.mr.verifikasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Review</a>
                                    ...
                                    @elseif($cmf->step == 5)
                                        <a href="{{route('cmf.mr.verifikasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Review</a>
                                    @elseif($cmf->step == 9)
                                        <a href="{{route('cmf.mr.evaluasi',['slug' => $cmf->slug])}}" class="btn btn-dark mb-2">Verifikasi</a>
                                    @endif
                                @endif
                            </td>
                        </tr>
